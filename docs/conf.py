# -*- coding: utf-8 -*-
#
# mdfelib documentation build configuration file, created by
...
latex_documents = [
  ('index', 'mdfelib.tex', u'mdfelib Documentation',
...
man_pages = [
    ('index', 'mdfelib', u'mdfelib Documentation',
     [u'Dave Kuhlman'], 1)
]
