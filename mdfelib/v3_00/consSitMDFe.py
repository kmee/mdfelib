...
#
# Command line:
#   /usr/local/bin/generateDS --export="etree" --no-namespace-defs -o "mdfelib/v3_00/consSitMDFe.py" schemas/v3_00/consSitMDFe_v3.00.xsd
#
...
class TConsSitMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='TConsSitMDFe', prefix_=None, mapping_=None):
...
class TRetConsSitMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='TRetConsSitMDFe', prefix_=None, mapping_=None):
        if parent_element is None:
            element = etree_.Element('{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
        else:
            element = etree_.SubElement(parent_element, '{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
        ...
        for procEventoMDFe_ in self.procEventoMDFe:
            procEventoMDFe_.to_etree(element, name_='procEventoMDFe', mapping_=mapping_)
        if mapping_ is not None:
            mapping_[self] = element
        return element
    def build(self, node):
...
class protMDFeType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='protMDFeType', prefix_=None, mapping_=None):
        if parent_element is None:
            element = etree_.Element('{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
        else:
            element = etree_.SubElement(parent_element, '{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
        if self.versao is not None:
            element.set('versao', self.gds_format_string(self.versao))
...
class procEventoMDFeType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='procEventoMDFeType', prefix_=None, mapping_=None):
        if parent_element is None:
            element = etree_.Element('{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
        else:
            element = etree_.SubElement(parent_element, '{http://www.portalfiscal.inf.br/mdfe}' + name_, nsmap={prefix_: 'http://www.portalfiscal.inf.br/mdfe'})
