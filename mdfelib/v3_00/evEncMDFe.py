...
#
# Generated Mon Jun  4 08:46:47 2018 by generateDS.py version 2.29.2.
...
class evEncMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evEncMDFe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='evEncMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evEncMDFe'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='evEncMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dtEnc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtEnc>%s</dtEnc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dtEnc), input_name='dtEnc')), eol_))
