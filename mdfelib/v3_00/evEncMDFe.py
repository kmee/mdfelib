...
#
# Generated Thu Aug 30 15:52:27 2018 by generateDS.py version 2.29.3.
...
#
# Command line:
#   /usr/local/bin/generateDS --export="etree" --no-namespace-defs -o "mdfelib/v3_00/evEncMDFe.py" schemas/v3_00/evEncMDFe_v3.00.xsd
#
...
class evEncMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='evEncMDFe', prefix_=None, mapping_=None):
        ...
        if self.dtEnc is not None:
            dtEnc_ = self.dtEnc
            etree_.SubElement(element, '{http://www.portalfiscal.inf.br/mdfe}dtEnc').text = self.gds_format_string(dtEnc_)
