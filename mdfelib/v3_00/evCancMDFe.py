...
#
# Generated Thu Aug 30 15:52:26 2018 by generateDS.py version 2.29.3.
...
#
# Command line:
#   /usr/local/bin/generateDS --export="etree" --no-namespace-defs -o "mdfelib/v3_00/evCancMDFe.py" schemas/v3_00/evCancMDFe_v3.00.xsd
#
...
class evCancMDFe(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, descEvento=None, nProt=None, xJust=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def to_etree(self, parent_element=None, name_='evCancMDFe', prefix_=None, mapping_=None):
        ...
        if self.xJust is not None:
            xJust_ = self.xJust
            etree_.SubElement(element, '{http://www.portalfiscal.inf.br/mdfe}xJust').text = self.gds_format_string(xJust_)
